...
import { Phone, MessageSquare, Mail, Clock, User, Edit, Check, X } from "lucide-react"
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  {editMode ? (
                    <div className="space-y-2 w-full">
                      ...
                      <Input name="phone" value={editedPerson.phone} onChange={handleInputChange} placeholder="Phone" />
                      <Input name="email" value={editedPerson.email} onChange={handleInputChange} placeholder="Email" />
                        ...
                        <div className="mt-2 space-y-2">
                          {call.transcription.map((entry, i) => (
                            <div key={i} className={`flex ${entry.speaker === "AI" ? "justify-start" : "justify-end"}`}>
                              <div
                                className={`max-w-[80%] rounded-lg p-2 ${entry.speaker === "AI" ? "bg-primary text-primary-foreground" : "bg-secondary text-secondary-foreground"}`}
                              >
